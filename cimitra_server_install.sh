...
declare CUSTOM_ADMIN_ACCOUNT_ID_IN="admin@vlcm.com"
...
{
${SUDO_COMMAND} /var/opt/cimitra/api/server/create ${CIMITRA_SERVER_ADDRESS} ${CIMITRA_SERVER_PORT} ${CIMITRA_SERVER_ADMIN_ACCOUNT} ${CIMITRA_SERVER_ADMIN_PASSWORD} function=CHANGE_TO_CUSTOM_ADMIN_ID userId=admin@vlcm.com^ newUserId=${CUSTOM_ADMIN_ACCOUNT_ID}^
